...
<body>
	<div class="container-fluid background">
		<div class="row">
			...
			<div class="col-xs-9">
					<h2><marquee behavior="alternate">药品信息咨询系统</marquee></h2>
            </div>
		</div>
	</div>
				...
				<div class="background-div panel-body">
					<form action="" method="post" id="words_form" class="form-horizontal form-setting" role="form">
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" id="wname" name="wname" value="${user.username}" class="form-control input">
							</div>
						</div>
						<div class="form-group">
			...
			<div class=" modal modal-lg" id="result_text" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
				...
				<div class="modal-content">
					...
					<div class="modal-footer" style="text-align: center;">
							<a type="button" class="btn btn-success" href="words_look" >确认</a>
					</div>
				</div>
			</div>
